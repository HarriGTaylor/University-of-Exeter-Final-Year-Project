...
dis_tree<-ggtree(tree_rooted) %<+% in_data +
  ...
  geom_tiplab(aes(label = label, fill=group),
              ...
              colour=NA)+
  scale_fill_manual(name="Susceptibility to CPL1301", values = c("Susceptible to CPL1301" = "#009E73","Not Susceptible to CPL1301" = "#F0E442","Unknown" = "white", "Not ST131" ="grey", "ST131 Not Tested" = "#97D0F2"), breaks=legend_order) +
...
ggsave("Phylogenetic_tree_distance.png",dis_tree, width =6.2 , height =9.6 , dpi= 300 )
